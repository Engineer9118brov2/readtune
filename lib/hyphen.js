/*
 * ReadTune — offline hyphenation (syllable splitting)
 * Hypher by Bram Stein (BSD, see hypher.LICENSE.txt) + en-US TeX patterns.
 * Bundled locally; Manifest V3 forbids remote code.
 */
/* eslint-disable */
/**
 * @constructor
...
;
const _h = new Hypher(EN_US);
export function hyphenateWord(word) {
  try { return _h.hyphenate(word); } catch { return [word]; }
}
