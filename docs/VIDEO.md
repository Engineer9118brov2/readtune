# Demo video script (~3 min 30 s)

Judges score on **social impact (40%)**, technical (30%), innovation (20%),
design (10%). This script spends its time accordingly: the problem and a real
person first, the tech shown not explained, and it stays honest.

**Record it as:** you talking to camera for the framing bits, screen recording
for the demo, and — if at all possible — **10–20 seconds of a real dyslexic or
ADHD person using it and saying what they think, in their own words.** That clip
is worth more than any feature. If you can only get one thing for this video,
get that.
...
> "From now on I don't touch any settings."

- Open a real news article → **Alt+R** → clean, calibrated Reader View.
