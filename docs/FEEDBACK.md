...
GitHub issues are public. The feedback form explicitly asks people not to post
private article text, contact details, school information, or other sensitive
details; those belong in a consented session note, not a public issue.

Use participant IDs such as `P1`, never names or contact details. Do not add a
quote or clip unless that person separately approved its exact public use. Keep
the approval record outside this repository, and remove any public reference if
...
## Public quote and clip register

This remains empty until a participant has approved a specific public quote or
clip. It is evidence of feedback, not a clinical outcome claim.

| Participant ID | Approved asset | Approval date | Where used | Withdrawal status |
| --- | --- | --- | --- | --- |
| _No public evidence approved yet._ | | | | |
